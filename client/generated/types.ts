...
export type SearchTeamQuery = { __typename?: "Query" } & {
  teams: Array<
    { __typename?: "TeamModel" } & Pick<TeamModel, "id" | "title"> & {
        members?: Maybe<
          Array<
 ...
 * });
 */
export function useSearchTeamQuery(
  baseOptions?: Apollo.QueryHookOptions<
    SearchTeamQuery,
    SearchTeamQueryVariables
  >
) {
  return Apollo.useQuery<SearchTeamQuery, SearchTeamQueryVariables>(
    SearchTeamDocument,
    baseOptions
  );
}
export function useSearchTeamLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    SearchTeamQuery,
    SearchTeamQueryVariables
  >
) {
  return Apollo.useLazyQuery<SearchTeamQuery, SearchTeamQueryVariables>(
    SearchTeamDocument,
    baseOptions
  );
}
export type SearchTeamQueryHookResult = ReturnType<typeof useSearchTeamQuery>;
export type SearchTeamLazyQueryHookResult = ReturnType<
  typeof useSearchTeamLazyQuery
>;
export type SearchTeamQueryResult = Apollo.QueryResult<
  SearchTeamQuery,
  SearchTeamQueryVariables
>;
