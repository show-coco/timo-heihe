...
export type SearchTeamQueryVariables = Exact<{
  input?: Maybe<SearchTeamInput>;
}>;


export type SearchTeamQuery = (
  { __typename?: 'Query' }
  & { teams: Array<(
    { __typename?: 'TeamModel' }
    & Pick<TeamModel, 'id' | 'title'>
...
export function useFetchCategoryQuery(baseOptions?: Apollo.QueryHookOptions<FetchCategoryQuery, FetchCategoryQueryVariables>) {
        return Apollo.useQuery<FetchCategoryQuery, FetchCategoryQueryVariables>(FetchCategoryDocument, baseOptions);
      }
export function useFetchCategoryLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<FetchCategoryQuery, FetchCategoryQueryVariables>) {
          return Apollo.useLazyQuery<FetchCategoryQuery, FetchCategoryQueryVariables>(FetchCategoryDocument, baseOptions);
        }
...
export const SearchTeamDocument = gql`
...
/**
 * __useSearchTeamQuery__
 *
 * To run a query within a React component, call `useSearchTeamQuery` and pass it any options that fit your needs.
 * When your component renders, `useSearchTeamQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useSearchTeamQuery({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useSearchTeamQuery(baseOptions?: Apollo.QueryHookOptions<SearchTeamQuery, SearchTeamQueryVariables>) {
        return Apollo.useQuery<SearchTeamQuery, SearchTeamQueryVariables>(SearchTeamDocument, baseOptions);
      }
export function useSearchTeamLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<SearchTeamQuery, SearchTeamQueryVariables>) {
          return Apollo.useLazyQuery<SearchTeamQuery, SearchTeamQueryVariables>(SearchTeamDocument, baseOptions);
        }
export type SearchTeamQueryHookResult = ReturnType<typeof useSearchTeamQuery>;
export type SearchTeamLazyQueryHookResult = ReturnType<typeof useSearchTeamLazyQuery>;
export type SearchTeamQueryResult = Apollo.QueryResult<SearchTeamQuery, SearchTeamQueryVariables>;
 ...
 * });
 */
export function useFetchSkillQuery(baseOptions?: Apollo.QueryHookOptions<FetchSkillQuery, FetchSkillQueryVariables>) {
        return Apollo.useQuery<FetchSkillQuery, FetchSkillQueryVariables>(FetchSkillDocument, baseOptions);
      }
export function useFetchSkillLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<FetchSkillQuery, FetchSkillQueryVariables>) {
          return Apollo.useLazyQuery<FetchSkillQuery, FetchSkillQueryVariables>(FetchSkillDocument, baseOptions);
        }
export type FetchSkillQueryHookResult = ReturnType<typeof useFetchSkillQuery>;
export type FetchSkillLazyQueryHookResult = ReturnType<typeof useFetchSkillLazyQuery>;
export type FetchSkillQueryResult = Apollo.QueryResult<FetchSkillQuery, FetchSkillQueryVariables>;
