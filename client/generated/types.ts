...
export type TeamCardFragment = (
  { __typename?: 'TeamModel' }
  & Pick<TeamModel, 'id' | 'title' | 'description' | 'icon' | 'recruitNumbers' | 'isRequired' | 'repositoryUrl' | 'createdAt'>
  & { members?: Maybe<Array<(
    { __typename?: 'TeamMemberModel' }
...
export type TeamEditPageQuery = (
  ...
  & { team: (
    { __typename?: 'TeamModel' }
    & Pick<TeamModel, 'id' | 'title' | 'name' | 'description' | 'icon' | 'recruitNumbers' | 'isRequired' | 'repositoryUrl'>
    & { members?: Maybe<Array<(
      { __typename?: 'TeamMemberModel' }
