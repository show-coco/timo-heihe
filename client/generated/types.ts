...
export type ChannelItemFragment = (
  { __typename?: 'ChannelModel' }
  & Pick<ChannelModel, 'id' | 'name'>
);

export type ChannelListFragment = (
  { __typename?: 'UserMemberModel' }
...
export type RoomCardFragment = (
  { __typename?: 'RoomModel' }
  & Pick<RoomModel, 'id' | 'title' | 'slug' | 'description' | 'icon' | 'recruitNumbers' | 'isRequired' | 'repositoryUrl' | 'createdAt'>
  & { members?: Maybe<Array<(
    { __typename?: 'RoomMemberModel' }
    & Pick<RoomMemberModel, 'id' | 'userId' | 'name' | 'avatar' | 'memberState'>
  )>>, owner: (
    { __typename?: 'UserModel' }
...
export type RoomItemFragment = (
  { __typename?: 'UserMemberModel' }
  & Pick<UserMemberModel, 'id' | 'name' | 'icon'>
);
...
export type RoomEditPageQuery = (
  ...
  & { room: (
    { __typename?: 'RoomModel' }
    & Pick<RoomModel, 'id' | 'title' | 'name' | 'slug' | 'description' | 'icon' | 'recruitNumbers' | 'isRequired' | 'repositoryUrl'>
    & { members?: Maybe<Array<(
      { __typename?: 'RoomMemberModel' }
      & Pick<RoomMemberModel, 'id' | 'name' | 'avatar'>
    )>>, owner: (
      { __typename?: 'UserModel' }
      & Pick<UserModel, 'id' | 'name' | 'avatar'>
    ), skills?: Maybe<Array<(
  ...
  & { user: (
    ...
    & { skills?: Maybe<Array<(
      ...
      & { skills?: Maybe<Array<(
        ...
        { __typename?: 'RoomMemberModel' }
        & Pick<RoomMemberModel, 'id' | 'userId'>
      )>> }
    )>> }
  ), skills: Array<(
    { __typename?: 'SkillModel' }
...
export type RoomQuery = (
  ...
  & { room: (
    { __typename?: 'RoomModel' }
    & Pick<RoomModel, 'id' | 'title' | 'name' | 'description' | 'icon' | 'recruitNumbers' | 'isRequired' | 'repositoryUrl'>
    & { members?: Maybe<Array<(
      { __typename?: 'RoomMemberModel' }
      & Pick<RoomMemberModel, 'id' | 'userId' | 'name' | 'avatar' | 'memberState'>
    )>>, owner: (
